...
$sql=mysqli_query($con, "UPDATE student SET name='$name', phone='$phone', puja='$puja', date='$date', address='$address' WHERE id='$hid' ");
...
<input type="text" value="<?php echo $row['name']; ?>" name="name" placeholder="नाम लिखें">
</div>

<div class="group">
<label>मोबाइल</label>
<input type="tel" value="<?php echo $row['phone']; ?>" name="phone" placeholder="मोबाइल नंबर">
</div>

<div class="group">
<label>पूजा चुनें</label>

<select name="puja" value="<?php echo $row['puja']; ?>">
...
<textarea name="address" placeholder="पूरा पता"><?php echo $row['address']; ?></textarea>
</div>
